# January 2025 (Released in April)

* Removed old Arm Servo Shroud
* Added a Raspberry PI 5 Model and Mount
* Added a shim for the Shoulder Servo
* Updated Battery Doors with new magnet layout
* Added drawing for Idler Lockdown Plate
* Added drawing for Lower Torso Covering Mount Plate
* Added drawing for Console Gear Arms
* Added acrylic Status Plate for the Console
* Removed ‘3D Printable Parts’ folder. Many things were outdated
* Added Military Head Armor
* Updated Neck Tensioner Cover thickness
* Adjustments to Arm core piece
* Adjusted the Cradle Base side mounts to allow spacing for fasteners
* Lots of Lower Torso Covering changes
  * Adjustment to curved section to remove locating feature
  * Swapped out small circular magnets on console side panels with larger flat magnets
  * Adjusted top section to add chamfers for 3D printing
  * Added cable passthrough for console section servo
  * Adjusted console faceplate to allow cable routing of power button
  * Added status light section to the Console case
  * Started adding nurnies to the battery doors
  * Started adding split surfaces for the top section
  * Added chamfer to battery doors to ease closing
  * Adjusted the door rack frame to allow over-tightening

# October 2024 (Released in November)

* Added drawings for finger linkages
* Add drawing for finger hook
* Small tolerance change to the twist pulley cable clamp
* Added drawings for shoulder parts
* Added drawing for neck 8MM D*Shaft
* Added new Track drive Idler Tensioner Assembly
* More rebuild of the lower torso covering
  * Rebuild of entire console section into a main body and magnet attachable side portions
  * A rebuild of the battery frame area where the new door mechs live
  * Split frame area into multiple parts to aid in printing
  * Finished console door mechanism, and mounting blocks
  * Removed duplicate or out of date parts
  * Completed section split and added mounting hardware to lower torso covering
  * Added battery simulate and lugs
  * Updated the pivot point covering to cover the entire metal section
  * Updated Lower toro side plates to add a countersink where the covering mount brackets are
* Updated Goodyear tire with custom design for upcoming manufacturing
* Updated covering mount to align with differing configuring of existing tires
* Added gimbal ring / rod drawings
* Made small adjustments to neck rods and removed some superfluous features
* Added drawings for neck rod ends
* Added 3D printable sleeves for replacement spring spacers
* Modified neck sprocket to match the keyway of the neck rods to minimize the key plate needs
* Added drawing for socket
* Updated the front idler sprocket to use a lock nut instead of a collar
* Small adjustment to the cover plates on the neck rods
* Increased the height of the neck rod potentiometer covering
* Increased the wire passthrough on the neopixel retaining ring in the eye

# July 2024

* Updated neck slide design to a 2-piece 3D print and laser cut design
* Added new Battery Door Mechanism to the Lower Torso Covering (STILL IN ALPHA)
* Added new Console Door Mechanism to Lower Torso Covering (STILL IN ALPHA)
* Updates the the Hand / Finger / Thumb design to use off the shelf pulleys and spacers
* Added new Console Face Plate assembly to work with a new LCD Touchscreen and button design
* Added new Shoulder shaft extension design to eliminate the set screws
* Updated tolerances on Shoulder plates to fit within the laser cut tube (in optimal conditions)
* Updates to arm design (Right arm might not be in sync with left arm) to accommodate fastener and hex standoff adjustments.
* Added a cable sheathing spool spacer to the arm design to prevent the sheathed cables from pushing off the arm covering.
* Small adjustments to the shoulder tube front covering. Extended it down so it hugs the tube better. Added a mount for magnetic attachment. (Still needs a small tweak to prevent collision)
* Added adhesive tape to the Neck C-Channel and opened up the holes in the spring plate
* Added part info to eye vent holding pin

# April 2024 (Released in May)

* Added a number of drawings for arm parts
* Added Left Arm
* Added Flipped configurations of servo cable cages
* Added wire guide for finger cables
* Adjusted the angle of the cable paths for the fingers
* Adjusted finger designs and knobs with inspiration  from work done by Kyle Dedonya
* Switched out finger pulleys for those that can be purchased
* Added a configuration for the cradle base strengthening plate to be used with V2 cradle bases
* Added a series of drawings for hand / arm / wrist parts for production
* Made small adjustments to hand parts in preparation for production
* Added the new V3 Neck Assembly with the 3D printed neck block
* Added a new servo tensioner design and covering
* Material change on Master Cylinder Drive arm
